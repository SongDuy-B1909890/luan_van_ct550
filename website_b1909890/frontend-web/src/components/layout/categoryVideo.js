...
const CategoryVideoPage = () => {
    ...
    const category = "-Ni2oT1OjzLvW5OjQNiV";
    useEffect(() => {
        axios
            ...
            .then((response) => {
                ...
                const filteredVideos = videosData.filter((video) => video.id_category === category);
    ...
    useEffect(() => {
        ...
        const filteredUsers = users.filter((user) =>
            videos.some((video) => video.id_user === user.id && video.id_category === category)
        );
